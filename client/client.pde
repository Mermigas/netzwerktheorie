...
void oscEvent(OscMessage theOscMessage) {
  //print("es kommt was an");
  //String address = theOscMessage.address();
  //if (!address.contains(ownNetworkAddress) && theOscMessage.checkAddrPattern("/schall_2") == true)
  if ( theOscMessage.checkAddrPattern("/schall_2") == true)
  {
